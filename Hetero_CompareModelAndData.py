...
PRW_theta_std_dev = np.array((PRW_params_readlines[1].split('=')[1]).strip('[ ] \n').split(','),dtype=float)
...
for i in range(Nwalkers):
    df = run_PRW_sim(1, dt, time, PRW_theta_std_dev[i])
...
plt.legend()
plt.savefig('figures/hetero_model/acf_velocity_modelcomaparion_{}'.format(region))
plt.clf()
...
plt.xlim(0,min_track_length-2)
plt.ylim(-1,1)
plt.savefig('figures/hetero_model/single_exp_acf_vel_fit_PRWPB_{}.png'.format(region))
plt.clf()
...
plt.xlim(0,min_track_length-2)
plt.ylim(-1,1)
plt.savefig('figures/hetero_model/single_exp_acf_vel_fit_data_{}.png'.format(region))
plt.clf()
...
plt.xlim(0,min_track_length-2)
plt.ylim(-1,1)
plt.savefig('figures/hetero_model/double_exp_acf_vel_fit_PRWPB_{}.png'.format(region))
plt.clf()
...
plt.xlim(0,min_track_length-2)
plt.ylim(-1,1)
plt.savefig('figures/hetero_model/double_exp_acf_vel_fit_data_{}.png'.format(region))
plt.clf()
...
plt.legend()
plt.savefig('figures/hetero_model/dxdy_cdf_modelcomaparion_{}'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/dx_dy_boxplot_{}.png'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/vx_vy_boxplot_{}.png'.format(region))
plt.clf()
...
plt.text(.2, 20, 'tstatistic PRW={}, pvalue PRW={}'.format(round(tstat_PRW,3),round(pval_PRW,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.savefig('figures/hetero_model/velocity_boxplot_{}.png'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/DoverT_boxplot_{}.png'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/trajectories_data_{}'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/trajectories_PRWPBsim_{}'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/trajectories_PRWsim_{}'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/track_lengths_data_{}.png'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/omega_vs_time_PRWPB_{}.png'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/theta_vs_time_PRWPB_{}.png'.format(region))
plt.clf()
...
plt.savefig('figures/hetero_model/theta_vs_time_data_{}.png'.format(region))
plt.clf()
...
plt.ylabel('MSD')
plt.legend()
plt.savefig('figures/hetero_model/MSD_{}.png'.format(region))
plt.clf()