...
open('sentinels/filter_histogram_boxplot.txt','w').close()
#create new sentinel file to write to
hist_boxplot_figs = open('sentinels/filter_histogram_boxplot.txt','w')
file_lines = []
...
figure_path = save_path + '/filter_histogram_boxplot'
