...
open('sentinels/filtered_ACF_figures_{}.txt'.format(region),'w').close()
#create new sentinel file to write to
acf_fig_region = open('sentinels/filtered_ACF_figures_{}.txt'.format(region),'w')
file_lines = []

#filter based on D/T
region_endpointcells = region_endpointcells[region_endpointcells['DoverT'] > min_persistence] 

#names of experiments that meet this requirement
region_experiments = []
for i in range(len(region_endpointcells)):
  key_name = str(region_endpointcells.iloc[i]['experiment']) + '/' + str(region_endpointcells.iloc[i]['track_id'])
  region_experiments.append(key_name)
...
for i in range(len(tracks_geo_region)):
  ...
  if trial_df in region_experiments:
    filtered_tracks_geo_region.append(tracks_geo_region[i])
    filtered_tracks_region.append(tracks_region[i])
...
# plt.savefig('figures/filtered_acf_figures/{}_polarity_vector_acf_avg.png'.format(region))
# plt.clf()
# file_lines.append('figures/filtered_acf_figures/{}_polarity_vector_acf_avg.png \n'.format(region))
...
# plt.savefig('figures/filtered_acf_figures/{}_polarity_angle_acf_avg.png'.format(region))
# plt.clf()
# file_lines.append('figures/filtered_acf_figures/{}_polarity_angle_acf_avg.png \n'.format(region))
...
# plt.savefig('figures/filtered_acf_figures/{}_abs_skew_acf_avg.png'.format(region))
# plt.clf()
# file_lines.append('figures/filtered_acf_figures/{}_abs_skew_acf_avg.png \n'.format(region))
...
plt.savefig('figures/filtered_acf_figures/{}_velocity_angle_acf_avg.png'.format(region))
plt.clf()
file_lines.append('figures/filtered_acf_figures/{}_velocity_angle_acf_avg.png \n'.format(region))
...
plt.savefig('figures/filtered_acf_figures/{}_velocity_acf_avg.png'.format(region))
plt.clf()
file_lines.append('figures/filtered_acf_figures/{}_velocity_acf_avg.png \n'.format(region))
...
plt.savefig('figures/filtered_acf_figures/{}_speed_acf_avg.png'.format(region))
plt.clf()
file_lines.append('figures/filtered_acf_figures/{}_speed_acf_avg.png \n'.format(region))
...
plt.savefig('figures/filtered_acf_figures/{}_speed_x_acf_avg.png'.format(region))
plt.clf()
file_lines.append('figures/filtered_acf_figures/{}_speed_x_acf_avg.png \n'.format(region))
...
plt.savefig('figures/filtered_acf_figures/{}_speed_y_acf_avg.png'.format(region))
plt.clf()
file_lines.append('figures/filtered_acf_figures/{}_speed_y_acf_avg.png \n'.format(region))
...
plt.savefig('figures/filtered_acf_figures/{}_vel_pol_crosscorr_avg.png'.format(region))
plt.clf()
file_lines.append('figures/filtered_acf_figures/{}_vel_pol_crosscorr_avg.png \n'.format(region))
...
plt.savefig('figures/filtered_acf_figures/{}_pol_vel_crosscorr_avg.png'.format(region))
plt.clf()
file_lines.append('figures/filtered_acf_figures/{}_pol_vel_crosscorr_avg.png \n'.format(region))