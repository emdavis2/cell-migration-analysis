...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_polarity_vector_acf_avg.png}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_polarity_angle_acf_avg.png}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_abs_skew_acf_avg.png}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_velocity_angle_acf_avg.png}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_velocity_acf_avg.png}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_speed_acf_avg.png}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_speed_x_acf_avg.png}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.4\linewidth}
      \includegraphics[width=\linewidth]{figures/acf_figures/gel_speed_y_acf_avg.png}
