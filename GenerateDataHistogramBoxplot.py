...
tracks_region2, tracks_geo_region3, region3_cells, region3_endpointcells = compile_data_tracks(treatment3, min_track_length, region3, pixel_size)
...
plt.xlabel('D/T')
plt.ylabel('counts')
plt.savefig('figures/histogram_boxplot/DT_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/DT_hist_{}.png \n'.format(region3))
...
plt.xlabel(r'speed ($\mu m$/min)')
plt.ylabel('counts')
plt.savefig('figures/histogram_boxplot/speed_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/speed_hist_{}.png \n'.format(region3))
...
plt.xlabel('FMI')
plt.ylabel('counts')
plt.savefig('figures/histogram_boxplot/FMI_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/FMI_hist_{}.png \n'.format(region3))
...
plt.savefig('figures/histogram_boxplot/vel_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/vel_hist_{}.png \n'.format(region3))
...
plt.savefig('figures/histogram_boxplot/velx_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/velx_hist_{}.png \n'.format(region3))

plt.hist(vy_region3,bins=50)
plt.title(r'vy ($\mu m$/min) {}'.format(region3_name))
plt.savefig('figures/histogram_boxplot/vely_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/vely_hist_{}.png \n'.format(region3))
...
plt.savefig('figures/histogram_boxplot/absskew_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/absskew_hist_{}.png \n'.format(region3))
...
plt.savefig('figures/histogram_boxplot/dxdy_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/dxdy_hist_{}.png \n'.format(region3))

plt.hist(dx_region3,bins=50)
plt.title(r'dx ($\mu m$/min) {}'.format(region3_name))
plt.savefig('figures/histogram_boxplot/dx_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/dx_hist_{}.png \n'.format(region3))

plt.hist(dy_region3,bins=50)
plt.title(r'dy ($\mu m$/min) {}'.format(region3_name))
plt.savefig('figures/histogram_boxplot/dy_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/dy_hist_{}.png \n'.format(region3))
...
plt.text(.1, 18/10, 'statistic_12={}, pvalue_12={}'.format(round(tstat12,3),round(pval12,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, 1.2, 'statistic_13={}, pvalue_13={}'.format(round(tstat13,3),round(pval13,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, .9, 'statistic_23={}, pvalue_23={}'.format(round(tstat23,3),round(pval23,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
...
plt.text(.1, 12/10, 'statistic_12={}, pvalue_12={}'.format(round(tstat12,3),round(pval12,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
...
plt.text(.1, 15/10, 'pvalue_12={}'.format(pval12), fontsize = 12, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, 1, 'pvalue_13={}'.format(pval13), fontsize = 12, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, .6, 'pvalue_23={}'.format(pval23), fontsize = 12, bbox = dict(facecolor = 'red', alpha = 0.1))
...
plt.text(.1, 0.8, 'pvalue_12={}'.format(pval12), fontsize = 12, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, 0.4, 'pvalue_13={}'.format(pval13), fontsize = 12, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, 0.1, 'pvalue_23={}'.format(pval23), fontsize = 12, bbox = dict(facecolor = 'red', alpha = 0.1))
...
plt.text(.1, 0.7, 'statistic_12={}, pvalue_12={}'.format(round(tstat12,3),round(pval12,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, 0.3, 'statistic_13={}, pvalue_13={}'.format(round(tstat13,3),round(pval13,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
plt.text(.1, 0.1, 'statistic_23={}, pvalue_23={}'.format(round(tstat23,3),round(pval23,5)), fontsize = 8, bbox = dict(facecolor = 'red', alpha = 0.1))
...
plt.ylabel('counts')
plt.title('Track lengths for {} data'.format(region1_name))
plt.savefig('figures/histogram_boxplot/track_lengths_data_{}.png'.format(region1))
plt.clf()
file_lines.append('figures/histogram_boxplot/track_lengths_data_{}.png \n'.format(region1))
...
plt.xlabel('track length (number of frames)')
plt.ylabel('counts')
plt.title('Track lengths for {} data'.format(region2_name))
plt.savefig('figures/histogram_boxplot/track_lengths_data_{}.png'.format(region2))
plt.clf()
file_lines.append('figures/histogram_boxplot/track_lengths_data_{}.png \n'.format(region2))
...
plt.xlabel('track length (number of frames)')
plt.ylabel('counts')
plt.title('Track lengths for {} data'.format(region3_name))
plt.savefig('figures/histogram_boxplot/track_lengths_data_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/track_lengths_data_{}.png \n'.format(region3))
...
plt.savefig('figures/histogram_boxplot/trajectories_data_{}.png'.format(region1))
plt.clf()
file_lines.append('figures/histogram_boxplot/trajectories_data_{}.png \n'.format(region1))
...
plt.savefig('figures/histogram_boxplot/trajectories_data_{}.png'.format(region2))
plt.clf()
file_lines.append('figures/histogram_boxplot/trajectories_data_{}.png \n'.format(region2))
...
plt.savefig('figures/histogram_boxplot/trajectories_data_{}.png'.format(region3))
plt.clf()
file_lines.append('figures/histogram_boxplot/trajectories_data_{}.png \n'.format(region3))
