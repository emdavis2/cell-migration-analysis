...
# Create the autocorrelation figures filtering out tracks that do not meet the minimum track length 
sentinels/ACF_figures.txt: .created-dirs data/stiff_gel\
 ...
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 GenerateDataACF.py ['data/glass/8_26_PDMS','data/stiff_gel/8_26_PDMS','data/soft_gel/8_26_PDMS'] 30 ['glass','stiff_gel','soft_gel'] 'figures'

# Create the autocorrelation figures filtering out tracks that do not meet the minimum track length specified AND cuts all tracks to that min track length
sentinels/cuttrack_ACF_figures.txt: .created-dirs data/stiff_gel\
 functions/acf_functions.py functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 CutTrack_ACF.py ['data/glass/combined','data/stiff_gel/combined'] 30 ['glass','stiff_gel'] 'cuttrack_combined_figures'

# Create the autocorrelation figures filtering out tracks that do not meet the minimum track length specified AND filters out cells that do not displace more or equal to 3 cell lengths over entire track
sentinels/filterdist_ACF_figures.txt: .created-dirs data/stiff_gel\
 functions/acf_functions.py functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 FilterDist_ACF.py ['data/glass/combined','data/stiff_gel/combined'] 30 ['glass','stiff_gel'] 'combined_filterdist_figures'

# Create the autocorrelation figures filtering out tracks that do not meet the minimum track length specified AND cuts all tracks to that min track length AND filters out cells that do not displace more or equal to 3 cell lengths over entire track
sentinels/cutfilter_ACF_figures.txt: .created-dirs data/stiff_gel\
 functions/acf_functions.py functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 CutFilterDist_ACF.py ['data/glass/combined','data/stiff_gel/combined'] 30 ['glass','stiff_gel'] 'combined_cutfilterdist_figures'

# Create the boxplot and histogram figures filtering out tracks that do not meet the minimum track length 
sentinels/histogram_boxplot.txt: .created-dirs 2023_03_30_Data/glass_data\
 ...
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 GenerateDataHistogramBoxplot.py ['data/glass/8_26_PDMS','data/stiff_gel/8_26_PDMS','data/soft_gel/8_26_PDMS'] 30 ['glass','stiff_gel','soft_gel'] 'figures'


# Create the boxplot and histogram figures filtering out tracks that do not meet the minimum track length specified AND filters out cells that do not displace more or equal to 3 cell lengths over entire track
sentinels/filterdist_histogram_boxplot.txt: .created-dirs 2023_03_30_Data/glass_data\
 2023_03_30_Data/soft_gel_data 2023_03_30_Data/stiff_gel_data functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 FilterDistance_HistogramBoxplot.py ['data/glass/combined','data/stiff_gel/combined'] 30 ['glass','stiff_gel'] 'combined_filterdist_figures'

# Create the boxplot and histogram figures filtering out tracks that do not meet the minimum track length specified AND cuts all tracks to that min track length
sentinels/cuttrack_histogram_boxplot.txt: .created-dirs 2023_03_30_Data/glass_data\
 2023_03_30_Data/soft_gel_data 2023_03_30_Data/stiff_gel_data functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 CutTrackGenerateHistogramBoxplot.py ['data/glass/combined','data/stiff_gel/combined'] 30 ['glass','stiff_gel'] 'cuttrack_combined_figures'

# Create the boxplot and histogram figures filtering out tracks that do not meet the minimum track length specified AND cuts all tracks to that min track length AND filters out cells that do not displace more or equal to 3 cell lengths over entire track
sentinels/cutfilterdist_histogram_boxplot.txt: .created-dirs 2023_03_30_Data/glass_data\
 2023_03_30_Data/soft_gel_data 2023_03_30_Data/stiff_gel_data functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 CutTrackFilterDist_HistogramBoxplot.py ['data/glass/combined','data/stiff_gel/combined'] 30 ['glass','stiff_gel'] 'combined_cutfilterdist_figures'

# # Create the boxplot and histogram figures for both glass and gel data
# sentinels/density_histogram_boxplot.txt: .created-dirs 2023_03_30_Data/glass_data\
#  2023_03_30_Data/soft_gel_data 2023_03_30_Data/stiff_gel_data functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py
# 	python3 densityexploration_HistogramBoxplot.py ['data/glass/7_21_PDMS','data/stiff_gel/7_21_PDMS'] 30 ['glass','soft_gel'] 'density_figures'

# Create the autocorrelation figures for split in half glass and gel data
...
# Create the autocorrelation figures filtering out tracks that do not meet the min track length AND tracks longer than 120
sentinels/filter_ACF_figures.txt: .created-dirs data/stiff_gel\
 functions/acf_functions.py functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 tracklengthfilter_acf_tracklength.py ['data/glass/polyacrylamide','data/stiff_gel/polyacrylamide','data/soft_gel/polyacrylamide','data/glass/7_21_PDMS','data/soft_gel/7_21_PDMS'] 30 ['glass','stiff_gel','soft_gel','glass','soft_gel'] 'figures'

# Create the boxplot and histogram figures filtering out tracks that do not meet the min track length AND tracks longer than 120
sentinels/filter_histogram_boxplot.txt: .created-dirs 2023_03_30_Data/glass_data\
 2023_03_30_Data/soft_gel_data 2023_03_30_Data/stiff_gel_data functions/compile_data_tracks_function.py\
 functions/libraries/track_functions.py functions/libraries/qc_functions.py\
 functions/libraries/filter_cells_fns.py functions/libraries/centers.py
	python3 filtertracklength_histogramboxplot.py ['data/glass/polyacrylamide','data/stiff_gel/polyacrylamide','data/soft_gel/polyacrylamide','data/glass/7_21_PDMS','data/soft_gel/7_21_PDMS'] 30 ['glass','stiff_gel','soft_gel','glass','soft_gel'] 'figures'

# # Create the autocorrelation figures binning tracks by D/T
...
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py
# 	python3 CellShapeOverTrack.py 'data/glass/polyacrylamide' 'data/soft_gel/polyacrylamide' 'data/stiff_gel/polyacrylamide' 30 'glass' 'soft_gel' 'stiff_gel'
...
# model/model_params_glass_LPRW_vel_acf.txt: .created-dirs data/glass functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/model_fitting_functions.py functions/langevin_PRW_functions.py
# 	python3 RunGridSearchFitModel.py 'data/glass' 30 'glass' 5 0.1667 4 'LPRW' 'vel_acf' 'S' 10 50 20 'P' 0.5 5 20 0 0 0 0

# #Perform grid search to fit PRW model to soft gel data with vel acf
# model/model_params_soft_gel_LPRW_vel_acf.txt: .created-dirs data/soft_gel functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/model_fitting_functions.py functions/langevin_PRW_functions.py
# 	python3 RunGridSearchFitModel.py 'data/soft_gel' 30 'soft_gel' 5 0.1667 12 'LPRW' 'vel_acf' 'S' 10 50 20 'P' 0.5 5 20 0 0 0 0

# #Perform grid search to fit PRW model to stiff gel data with vel acf
# model/model_params_stiff_gel_LPRW_vel_acf.txt: .created-dirs data/stiff_gel functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/model_fitting_functions.py functions/langevin_PRW_functions.py
# 	python3 RunGridSearchFitModel.py 'data/stiff_gel' 30 'stiff_gel' 5 0.1667 5 'LPRW' 'vel_acf' 'S' 10 50 20 'P' 0.5 5 20 0 0 0 0

# #Perform grid search to fit PRW_polaritybias model to glass data with vel acf
# model/model_params_glass_PRW_PB_vel_acf.txt: .created-dirs data/glass functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/model_fitting_functions.py functions/PRWpolaritybias_model_functions.py
# 	python3 RunGridSearchFitModel.py 'data/glass' 30 'glass' 5 0.1667 4 'PRW_PB' 'vel_acf' 'std_dev_w' 0.2 0.9 10 'std_dev_theta' 0.9 1.5 10 0 0 0 0

# #Perform grid search to fit PRW_polaritybias model to soft gel data with vel acf
# model/model_params_soft_gel_PRW_PB_vel_acf.txt: .created-dirs data/soft_gel functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/model_fitting_functions.py functions/PRWpolaritybias_model_functions.py
# 	python3 RunGridSearchFitModel.py 'data/soft_gel' 30 'soft_gel' 5 0.1667 12 'PRW_PB' 'vel_acf' 'std_dev_w' 0.2 0.9 10 'std_dev_theta' 0.9 1.5 10 0 0 0 0

# #Perform grid search to fit PRW_polaritybias model to stiff gel data with vel acf
# model/model_params_stiff_gel_PRW_PB_vel_acf.txt: .created-dirs data/stiff_gel functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/model_fitting_functions.py functions/PRWpolaritybias_model_functions.py
# 	python3 RunGridSearchFitModel.py 'data/stiff_gel' 30 'stiff_gel' 5 0.1667 5 'PRW_PB' 'vel_acf' 'std_dev_w' 0.2 0.9 10 'std_dev_theta' 0.9 1.5 10 0 0 0 0
...
# sentinels/figs_velacf_model_glass.txt: .created-dirs data/glass functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/msd_functions.py functions/PRWpolaritybias_model_functions.py functions/weighted_PRW_model_functions.py functions/PRW_model_functions.py functions/langevin_PRW_functions.py\
...
# 	python3 CompareModelAndData.py 'data/glass' 30 'glass' 5 0.1667 4 'model/model_params_glass_LPRW_vel_acf.txt' 'model/model_params_glass_PRW_PB_vel_acf.txt' 'figures/velacf_model/'

# #Make figures comparing models with optimal parameters to soft gel data using vel_acf fitting metric
# sentinels/figs_velacf_model_soft_gel.txt: .created-dirs data/soft_gel functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/msd_functions.py functions/PRWpolaritybias_model_functions.py functions/weighted_PRW_model_functions.py functions/PRW_model_functions.py functions/langevin_PRW_functions.py\
...
# 	python3 CompareModelAndData.py 'data/soft_gel' 30 'soft_gel' 5 0.1667 12 'model/model_params_soft_gel_LPRW_vel_acf.txt' 'model/model_params_soft_gel_PRW_PB_vel_acf.txt' 'figures/velacf_model/'

# #Make figures comparing models with optimal parameters to gel data using vel_acf fitting metric
# sentinels/figs_velacf_model_stiff_gel.txt: .created-dirs data/stiff_gel functions/compile_data_tracks_function.py\
#  functions/libraries/track_functions.py functions/libraries/qc_functions.py\
#  functions/libraries/filter_cells_fns.py functions/libraries/centers.py\
#  functions/acf_functions.py functions/msd_functions.py functions/PRWpolaritybias_model_functions.py functions/weighted_PRW_model_functions.py functions/PRW_model_functions.py functions/langevin_PRW_functions.py\
...
# 	python3 CompareModelAndData.py 'data/stiff_gel' 30 'stiff_gel' 5 0.1667 5 'model/model_params_stiff_gel_LPRW_vel_acf.txt' 'model/model_params_stiff_gel_PRW_PB_vel_acf.txt' 'figures/velacf_model/'
